defmodule ElixirTrees.TreeTraversal do
  ...
  ## Examples
   iex> ElixirTrees.TreeTraversal.traverse(nil, fn x, _, _ -> {:continue, x} end, :bfs)
   []

   iex> ElixirTrees
   ..(1)> .TreeTraversal
   ..(1)> .traverse(%ElixirTrees.Tree{value: 1,
   ..(1)>                             children: [%ElixirTrees.Tree{value: 2}, 
   ..(1)>                                        %ElixirTrees.Tree{value: 3},
   ..(1)>                                        %ElixirTrees.Tree{value: 4}]},
